...
?>
  ...
  <?php endif; ?>
  <!-- ./messages -->
  <h1 class="text-center">Welcome to FaceAfeka! <br><small>A simple Facebook clone.</small></h1>
  <br><small>Internet Application Course Final Project for Afeka College.</small></h1>
